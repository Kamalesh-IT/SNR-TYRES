...
export const brands = ["Michelin", "Goodyear", "Bridgestone", "Continental", "Pirelli", "JK Tyre"];
export const types = ["Summer", "Winter", "All-Season", "Off-Road"];
